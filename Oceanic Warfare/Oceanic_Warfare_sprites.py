...
class Cruiser(pg.sprite.Sprite):
    ...
    def update(self, rotate_ship, selected_ship, mouse_position, player_grid, game_battle_running, computer_turn, missile_position_y, missile_on):
        ...
        if rotate_ship == "cruiser" and self.position == "horizontal":
            ...
            if game_battle_running and computer_turn:
...
class AircraftCarrier(pg.sprite.Sprite):
    ...
    def update(self, rotate_ship, selected_ship, mouse_position, player_grid, game_battle_running, computer_turn, missile_position_y, missile_on):
        ...
        if rotate_ship == "aircraftcarrier" and self.position == "horizontal":
            ...
            for row_index in range(11):
                for column_index in range(11):
                    if player_grid[row_index][column_index] == 4:
                        list_of_cells.append([column_index, row_index])
            center_cell = list_of_cells[2]
            if game_battle_running and self.position == "horizontal" and computer_turn:
            ...
            elif game_battle_running and self.position == "horizontal":
            ...
            elif game_battle_running and self.position == "vertical" and computer_turn:
                ...
                self.rect.center = tuple([center_cell[0] * CELL_SIZE + CELL_SIZE / 2 + self.image.get_width() * 1/4 + TABLE_POSITION_X_MAIN_BATTLE - SCREEN_WIDTH, center_cell[1] * CELL_SIZE + CELL_SIZE / 2 + self.image.get_height() * 1/8 + TABLE_POSITION_Y])
            else:
    ...
    def update(self, rotate_ship, selected_ship, mouse_position, player_grid, game_battle_running, computer_turn, missile_position_y, missile_on):
        ...
        if rotate_ship == "destroyer" and self.position == "horizontal":
            ...
            if game_battle_running and self.position == "horizontal" and computer_turn:
                ...
                center_cell = list_of_cells[1]
                self.rect.center = tuple([center_cell[0] * CELL_SIZE + CELL_SIZE / 2 + TABLE_POSITION_X_MAIN_BATTLE - SCREEN_WIDTH, center_cell[1] * CELL_SIZE + CELL_SIZE / 2 + self.image.get_height() * 1/8 + TABLE_POSITION_Y])
            else:
                center_cell = list_of_cells[1]
